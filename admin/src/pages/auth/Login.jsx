...
export const Login = () => {
    ...
    const login = async(e) => {
        ...
        e.preventDefault();
        clearErrors();
        const loginResponse = await loginAdmin(loginEmail,loginPassword,rememberMe);
    ...
    return (
        <div id="login">
            ...
            <h2>Vsounds Admin Portal - Login</h2>
            <button disabled={loadingGoogle} className="google-btn" onClick={loginGoogle}><i className="fa-brands fa-google"></i> Login with google {loadingGoogle ? <CSpinner style={{marginLeft:'10px'}}/> : null}</button>
            <form id="login-form" onSubmit={login}>
                ...
                <button disabled={loading} id="submit-button">Login {loading ? <CSpinner style={{marginLeft:'10px'}}/> : null}</button>
