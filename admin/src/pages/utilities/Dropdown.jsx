    ...
    return <CDropdown dark id="my-dropdown">
            <CDropdownToggle color="dark" className="dropdown-icon"><i className="fa-solid fa-user fa-lg"></i></CDropdownToggle>
                <CDropdownMenu className="dropdown-menu">
                    ...
                    <CDropdownItem className="dropdown-item" component={Link} to={'/Products'}>Products</CDropdownItem>
                    <CDropdownItem className="dropdown-item" component={Link} to={'/Orders'}>Orders</CDropdownItem>
